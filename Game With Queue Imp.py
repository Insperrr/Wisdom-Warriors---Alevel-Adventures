...
class QuestionManager():
    ...
    def create_questions(self, no_questions):
        ...
        for question in data:
            ...
            self.questions.append(new_question)  # Add to queue
    
    def get_next_question(self):
        # Remove and return the first question
        if self.questions:
...
class GameInstance(BaseScreen):
    ...
    def change_question(self):
        ...
        # Increment question number if no specific number is provided
        self.current_question_number += 1
        
        # Check if there are no more questions in the queue
...
class GameSummary(BaseScreen):
    def __init__(self, player):
        ...
        self.all_buttons.add_button(self.continue_button, lambda: self.end_game_summary())
